...
*------------------------------------------------------------------------------ 
#call HenrardNormalizationpq(hk)
Global HtHenrard=hkHt'MAXORDER';
.store
#call HenrardInversepq(hkW'MAXORDER',H0,hki)
...
.store
#call HoriMersmanInversepq(hmG'MAXORDER',H0,h)
...
*       Algorithm by Koseleff PV (1994), Cel. Mech. 58:17–36.
*------------------------------------------------------------------------------ 
#call DragtFinnNormalizationpq(df)
Global HtDragtFinn=dfHt'MAXORDER';
.store
#call DragtFinnInversepq(dfG'MAXORDER',H0,dfi)
...
.store
#call GustavsonInversepq(gG'MAXORDER',H0,gh)
